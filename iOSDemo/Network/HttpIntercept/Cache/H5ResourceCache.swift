...
class H5ResourceCache: NSObject {
    /// 内存缓存大小：10M
    private let kMemoryCacheCostLimit: UInt = 100 * 1024 * 1024
    /// 磁盘文件缓存大小： 10M
    private let kDiskCacheCostLimit: UInt = 100 * 1024 * 1024
    /// 磁盘文件缓存时长：30 分钟
    private let kDiskCacheAgeLimit: TimeInterval = 1800
