...
class CitySearchResultView: UIView ,UITableViewDelegate,UITableViewDataSource{
    ...
    override init(frame: CGRect) {
        ...
        str.addAttributes([NSForegroundColorAttributeName:UIColor.Hex(hexString: "#999999"),NSAttributedStringKey.font:UIFont.systemFont(ofSize: 13)], range: NSMakeRange(0, str.length))
