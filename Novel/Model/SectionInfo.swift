        ...
        get{
            if _sectionAttributeContent == nil {
                do{
                    ...
                    try _sectionAttributeContent =   NSAttributedString(data: fontContent.data(using: .unicode)!, options: [NSDocumentTypeDocumentAttribute:NSHTMLTextDocumentType], documentAttributes: nil)
                }
                catch{
