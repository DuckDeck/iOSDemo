...
struct FiveStrokeDemo:UIViewControllerRepresentable {
    func updateUIViewController(_ uiViewController: UIViewControllerType, context: Context) {
        
    }
    typealias UIViewControllerType = FiveStrokeViewController
    
    func makeUIViewController(context: Context) -> FiveStrokeViewController {
        return FiveStrokeViewController()
    }
}
